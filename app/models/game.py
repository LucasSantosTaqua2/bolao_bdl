...
from sqlalchemy import Column, Integer, String, DateTime # <<< MUDANÇA: Certifique-se de que DateTime é importado

# Importar a Base declarativa do seu arquivo de banco de dados
...
class Game(Base): # Herda de Base
    ...
    # <<< MUDANÇA: Adicionar timezone=True para game_datetime
